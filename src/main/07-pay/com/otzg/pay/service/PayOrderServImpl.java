...
public class PayOrderServImpl extends AbstractServ implements PayOrderServ {
    ...
    public Map createPayOrderByUnit(String payChannelAccount, PayOrderDto payOrderDto) {
        ...
        try {
            ...
            //如果是微信或支付宝扫码付
            if (WxPayOrderDtoCheckUtil.TradeType.MICROPAY.name().equals(payOrderDto.getPayType())
                    || AliPayOrderDtoCheckUtil.TradeType.BARCODE.name().equals(payOrderDto.getPayType())) {
