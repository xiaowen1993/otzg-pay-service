...
//
//import com.otzg.wxpay.util.XmlUtil;
//import com.otzg.wxpay.util.company.WxpayConfig;
//import com.otzg.wxpay.util.sdk.WXPayConstants.SignType;
//
...
//        if (SignType.MD5.name().equals(this.signType)) {
//            reqData.put("sign_type", WXPayConstants.MD5);
//        }
//        else if (SignType.HMACSHA256.name().equals(this.signType)) {
...
//            }
//        }
//        return WXPayUtil.isSignatureValid(reqData, this.config.getKey(), signType.name());
//    }
//
//
//    /**
...
//     * @throws Exception
//     */
//    public Map<String, String> depositPayWithPos(Map<String, String> reqData) throws Exception {
//        return this.depositPayWithPos(reqData, this.config.getHttpConnectTimeoutMs());
//    }
//    public Map<String, String> depositPay(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
//        String url;
//        if (this.useSandbox) {
//            url = WXPayConstants.SANDBOX_DEPOSIT_FACEPAY_URL_SUFFIX;
//        }
//        else {
//            url = WXPayConstants.DEPOSIT_FACEPAY_URL_SUFFIX;
//        }
//        String respXml = this.requestWithoutCert(url, this.fillRequestData(reqData), connectTimeoutMs, readTimeoutMs);
//        return this.processResponseXml(respXml);
//    }
...
//     * @throws Exception
//     */
//    public Map<String, String> depositPayWithPos(Map<String, String> reqData, int connectTimeoutMs) throws Exception {
//        int remainingTimeMs = 60*1000;
//        long startTimestampMs = 0;
//        Map<String, String> lastResult = null;
//        Exception lastException = null;
...
//            if (readTimeoutMs > 1000) {
//                try {
//                    lastResult = this.depositPay(reqData, connectTimeoutMs, readTimeoutMs);
//                    String returnCode = lastResult.get("return_code");
//                    if (returnCode.equals("SUCCESS")) {
//                        String resultCode = lastResult.get("result_code");
//                        String errCode = lastResult.get("err_code");
...
//        String url = WxpayConfig.getPayRefundQueryUrl();
//        String respXml = this.requestWithoutCert(url, this.fillRequestData(reqData), connectTimeoutMs, readTimeoutMs);
//        return this.processResponseXml(respXml);
//    }
//
//
//    public Map<String, String> redPackPay(Map<String, String> reqData) throws Exception {
//        String url = WxpayConfig.getRePackPayUrl();
