...
public class WxpaySubmit {
     ...
     */
    public final static JSONObject postReceive(String appId,
                                               String mchId,
                                               String key,
                                               Map<String, String> map) throws Exception {

        WXPayConfig wxPayConfig = new WxPayConfigImpl(appId, mchId, key);
     ...
     * @author G/2016年10月27日 上午9:04:42
     */
    public final static Map<String, String> postMicroPay(String appId,
                                                         String mchId,
                                                         String key,
                                                         Map<String, String> map) throws Exception {
        WXPayConfig wxPayConfig = new WxPayConfigImpl(appId, mchId, key);

        WXPay wxpay = new WXPay(wxPayConfig, false, true);

        //内置60秒的轮询
        Map<String, String> result = wxpay.microPayWithPos(map);
     ...
     * 刷脸交押金
     */
    public final static Map<String, String> postDepositPay(String appId,
                                                           String mchId,
                                                           String key,
                                                           Map<String, String> map) throws Exception {
        WXPayConfig wxPayConfig = new WxPayConfigImpl(appId, mchId, key);
        ...
        //内置60秒的轮询
        Map<String, String> result = wxpay.depositPayWithPos(map);
        System.out.println("调用结果=" + result);
        //调用结果={transaction_id=4164583679620190411182047672979, nonce_str=LbQjExfMQquvNd7A7hapTT4SzjesdobU, bank_type=CMC, openid=085e9858e9914da9a0da5522a, sign=64DA7555B343847E35A316B3E1E10322, err_code=SUCCESS, err_code_des=ok, return_msg=OK, fee_type=CNY, mch_id=1519839251, cash_fee=1, device_info=001, out_trade_no=134520174432770725, cash_fee_type=CNY, total_fee=1, appid=wx4dc8cb7f0eb12288, trade_type=MICROPAY, result_code=SUCCESS, time_end=20190411182047, attach=测试刷卡付, is_subscribe=Y, return_code=SUCCESS}
        if (result.get("return_code") != null
                && result.get("return_code").equals("SUCCESS")
     ...
     * @author G/2016年10月27日 上午9:04:42
     */
    public final static JSONObject postRefundPay(String appId,
                                                 String mchId,
                                                 String key,
                                                 String signType,
                                                 String certRootPath,
                                                 Map<String, String> map) throws Exception {
        WXPayConfig wxPayConfig = new WxPayConfigImpl(appId, mchId, key,signType, certRootPath);
     ...
     * @author G/2016年10月27日 上午9:04:42
     */
    public final static JSONObject postRefundQuery(String appId,
                                                   String mchId,
                                                   String key,
                                                   Map<String, String> map) throws Exception {
     ...
     * @return
     */
    public final static Map<String, String> payQueryData(String outTradeNo) {
        Map<String, String> paramMap = new HashMap<String, String>();
        //随机数
        paramMap.put("nonce_str", WXPayUtil.generateNonceStr());
        //transaction_id是微信系统为每一笔支付交易分配的订单号，通过这个订单号可以标识这笔交易，它由支付订单API支付成功时返回的数据里面获取到。
     ...
     * @author G/2016年10月27日 上午9:04:42
     */
    public final static JSONObject postPayQuery(String appId,
                                                String mchId,
                                                String key,
                                                Map<String, String> map) throws Exception {
        ...
        if (result.get("result_code").equals("SUCCESS")) {
            ...
            if (result.get("trade_state").equals("SUCCESS")) {
                ...
                return JsonUtil.get(false, result.get("trade_state"), result.get("trade_state_desc"));
            }
        } else {
            System.out.println("调用失败");
            return JsonUtil.get(false, result.get("result_code"), "接口调用失败");
        }
    }
...
//        Map<String,String> result = postPayQuery(payConfig,payData);
...
//        String auth_code = "120269300684844649";
        String auth_code = "134597031960901618";
        String body = "付款码支付测试";
        String deviceInfo = "1000";

        Map<String, String> payData = microPayData(subMchId, attach, "1415757673001", auth_code, body, deviceInfo, new Double(0.01));
        Map<String, String> result = postMicroPay(appId, mchId, sandBoxKey, payData);
        System.out.println("result=" + result.toString());
        //2019-11-16 17:35
        ...
        //result={"success":true,"code":"SUCCESS","msg":"OK","data":{"transaction_id":"4984053905020191116173611584330","openid":"085e9858e9914da9a0da5522a"}}
    }
    ...
    public void receiveTest() throws Exception {
        Map<String, String> payData = receiveNativeData(subMchId, "测试订单1", "190108165433002", new Double(0.02));
        System.out.println("result=" + payData);
        Map<String, String> result = postReceive(appId, mchId, key, payData);
        System.out.println("result=" + result.toString());
        //result={"success":true,"code":"SUCCESS","msg":"OK","data":{"nonce_str":"ndzUve72uzM8LdZd","code_url":"weixin://wxpay/bizpayurl?pr=kDR2iY2","appid":"wxa574b9142c67f42e","sign":"BAB36AA33EA53D6692678135159BAFFCB5D57FFD6760BA6839287187967A27A4","trade_type":"NATIVE","return_msg":"OK","result_code":"SUCCESS","mch_id":"1513549201","sub_mch_id":"1525006091","return_code":"SUCCESS","prepay_id":"wx16092738940419169ca46d5f1586047600"}}
    }
    ...
    public void receiveDepositTest() throws Exception {
        ...
        Map<String, String> result = postDepositPay(appId, mchId, sandBoxKey, payData);
        System.out.println("result=" + result.toString());
        //2019-11-16 17:33
    ...
    public void refundTest() throws Exception {
        ...
        Map<String, String> payData = WxpaySubmit.refundData(subMchId, "", "10001772509067195318388364",outRefundNo, new Double(0.01), new Double(0.01));
        System.out.println("mchId=" + mchId);
        System.out.println("key=" + key);
        Map<String, String> result = postRefundPay(appId, mchId, key, WXPayConstants.SignType.HMACSHA256.name(), certRootPath, payData);
        System.out.println("result=" + result);
