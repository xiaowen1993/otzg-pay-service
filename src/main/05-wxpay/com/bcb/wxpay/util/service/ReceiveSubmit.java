...
//     * @return
//     */
//    public final static Map<String, String> refundQueryData(String subMchId, String outTradeNo,String outRefundNo) {
//        Map<String, String> paramMap = new HashMap<>();
//        //随机数
//        paramMap.put("sub_mch_id", subMchId);
//        //transaction_id是微信系统为每一笔支付交易分配的订单号，
//        // 通过这个订单号可以标识这笔交易，它由支付订单API支付成功时返回的数据里面获取到。
//        //根据API给的签名规则进行签名
////        paramMap.put("out_trade_no", outTradeNo);
//        paramMap.put("out_refund_no", outRefundNo);
//        return paramMap;
...
//        Map<String, String> payData = payQueryData(subMchId, "20191126155585940-1867378635");
...
//        Map<String, String> payData = ReceiveSubmit.refundData(subMchId, "", "1415757673002", outRefundNo, new Double(0.01), new Double(0.01));
//        Map<String, String> result = ReceiveSubmit.postRefundPay(payData);
//        System.out.println("result=" + result);
...
//        String subMchId="1525006091";
//        String outRefundNo = "20191128113553134861867378635";
//        String outTradeNo = "201911281133112801867378635";
//        Map<String, String> payData = ReceiveSubmit.refundQueryData(subMchId,outTradeNo,outRefundNo);
//        Map<String, String> result = ReceiveSubmit.postRefundQuery(payData);
//        System.out.println("result=" + result);
//
//    }
//
