...
import com.bcb.wxpay.util_v3.HttpClientCustomSSL;
...
public class WxpaySubmit {
     ...
     * @param totalFee 订单总金额，单位为分
     */
    public final static String ReceiveNativeData(String subMchId, String ordersName, String outTradeNo, Double totalFee) {
        Map<String, String> paramMap = getMchHead(WxpayConfig.APPMCHID);
...
//        return XmlUtil.parse(resultXml);
    ...
    public void getPublicKey() throws Exception {
        ...
        String resultXml = HttpClientCustomSSL.httpClientResultGetPublicKey(data);
        //6.0 解析返回的xml数据===》map集合
//        XmlUtil.parse(resultXml);
...
//	    
//		JSONObject r=WxpaySubmit.getOpenId(WxpayConfig.APPAPPID,WxpayConfig.APPSECRET,"001zAsV82z2p7P0o61X82vnoV82zAsVq");
...
//        String data=WxpaySubmit.ReceiveNativeData("test","34234234234234234",new Double(101));
        String data = WxpaySubmit.ReceiveNativeData(subMchId, "test", "34234234234234234", new Double(101));
