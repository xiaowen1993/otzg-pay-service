...
public class TestAlipay {
    ...
    public void test1() {
        ...
        JSONObject jo = new AlipaySubmit().appPay(appAuthToken,outTradeNo,subject,totalAmount);
    ...
    public void test2() {
        ...
        String totalAmount="0.01";
        JSONObject jo = new AlipaySubmit().precreatePay(appAuthToken,outTradeNo,subject,totalAmount);
        System.out.println("result=" + jo);
        //2019-12-6 15:29
    ...
    public void test3() {
        ...
        JSONObject jo = new AlipaySubmit().createPay(appAuthToken,outTradeNo,subject,totalAmount,buyerId);
        System.out.println("result=" + jo);
        //2019-12-6 15:29
    ...
    public void test4() {
        ...
        String totalAmount="0.01";
        JSONObject jo = new AlipaySubmit().facePay(appAuthToken,authCode,totalAmount);
        System.out.println("result=" + jo);
    ...
    public void testReceive() throws AlipayApiException {
        ...
        //李唐token
        //收款
        JSONObject jo = new AlipaySubmit().barCodPay(appAuthToken,authCode, "2019033011111111120", "测试收款", "0.01", null, "store_1");
        System.out.println("result=" + jo);
        //2019-12-5 9:46
...
//    String appAuthToken ="201912BBb50aa9efa15a49629cda9afa1fb46E27";
    String appAuthToken ="201912BB204e61defc5345cda32f0f2ffd3eaX96";
    @Test
    public void testReceiveQuery() throws AlipayApiException {
        //查询
        JSONObject jo = new AlipaySubmit().payQuery(appAuthToken,"20191211161824952745463060",null);
        System.out.println("result="+jo);
        //2019-12-05 9:48
    ...
    public void testAuthTokenQuery() {
        //查询
        JSONObject jo = new AlipaySubmit().authTokenQuery(appAuthToken);
        System.out.println("result="+ jo.getJSONObject("data"));
//        System.out.println("result="+ DateUtil.dateTime2Str(jo.getJSONObject("data").getDate("authEnd")));
   ...
   @Test
    public void testAuthTokenRefresh() {
        ...
        //刷新令牌
        JSONObject jo = new AlipaySubmit().getOpenAuthTokenAppByRefreshToken(appRefreshToken);
...
//        String outTradeNo ="201912101733375503745463060";
        ...
        JSONObject jo = new AlipaySubmit().refund(appAuthToken,outTradeNo,"0.01","1");
        System.out.println("result="+jo);
        //2019-12-05 9:52
    ...
    public void testRefundQuery() throws AlipayApiException {
        ...
        JSONObject jo = new AlipaySubmit().refundQuery(appAuthToken,outTradeNo,null);
        System.out.println("result="+jo);
        //2019-12-05 9:54
