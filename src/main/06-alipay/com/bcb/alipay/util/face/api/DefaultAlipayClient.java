//package com.bcb.alipay.util.face.api;
//
//
...
//
//    @Override
//    public <T extends com.alipay.api.AlipayResponse> void execute(com.alipay.api.AlipayRequest<T> request, AlipayCallBack callBack) {
