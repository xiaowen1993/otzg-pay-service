...
@Controller
public class AlipayMarketingCampaignCashCreateController {
	
    @RequestMapping(value="/alipayMarketingCampaignCashCreate.htm")
    public String toHtml(HttpServletRequest request,ModelMap modelMap){
        
        return "api/alipayMarketingCampaignCashCreate";
        
    }

    @RequestMapping(value="/alipayMarketingCampaignCashCreate.json", method = RequestMethod.POST)
    @ResponseBody
    public Object doPost(HttpServletRequest request,HttpServletResponse response,ModelMap modelMap,AlipayMarketingCampaignCashCreateModel alipayModel){
        Result<AlipayMarketingCampaignCashCreateResponse> result = new Result<AlipayMarketingCampaignCashCreateResponse>();
        Properties prop = AlipayConfig.getProperties();
        
		//初始化请求类
		AlipayMarketingCampaignCashCreateRequest alipayRequest = new AlipayMarketingCampaignCashCreateRequest();
		...
		try {
			...
			AlipayMarketingCampaignCashCreateResponse alipayResponse = alipayClient.execute(alipayRequest);
