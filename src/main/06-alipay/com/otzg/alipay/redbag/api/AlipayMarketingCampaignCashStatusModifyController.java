package com.otzg.alipay.redbag.api;
...
@Controller
public class AlipayMarketingCampaignCashStatusModifyController {
	
    @RequestMapping(value="/alipayMarketingCampaignCashStatusModify.htm")
    public String toHtml(HttpServletRequest request,ModelMap modelMap){
        
        return "api/alipayMarketingCampaignCashStatusModify";
        
    }

    @RequestMapping(value="/alipayMarketingCampaignCashStatusModify.json", method = RequestMethod.POST)
    @ResponseBody
    public Object doPost(HttpServletRequest request,HttpServletResponse response,ModelMap modelMap,AlipayMarketingCampaignCashStatusModifyModel alipayModel){
        Result<AlipayMarketingCampaignCashStatusModifyResponse> result = new Result<AlipayMarketingCampaignCashStatusModifyResponse>();
        Properties prop = AlipayConfig.getProperties();
        
		//初始化请求类
		AlipayMarketingCampaignCashStatusModifyRequest alipayRequest = new AlipayMarketingCampaignCashStatusModifyRequest();
		...
		try {
			...
			AlipayMarketingCampaignCashStatusModifyResponse alipayResponse = alipayClient.execute(alipayRequest);
